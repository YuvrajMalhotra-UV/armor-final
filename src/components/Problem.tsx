...
const CARDS: ReadonlyArray<ProblemCard> = [
  { icon: "⚡", title: "Prompt injection slips through", body: "A single hostile string in a webpage or ticket can hijack your agent's plan and trigger tool calls you never sanctioned." },
  { icon: "🔓", title: "RBAC stops users, not agents", body: "Identity tells you who is calling. It can't tell you whether the action matches the task the user actually asked for." },
  { icon: "👁", title: "Guardrails only filter words", body: "Output filters catch toxic text. They don't catch a polite agent quietly exfiltrating your billing database." },
];
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="max-w-3xl">
          ...
          >
            <span style={{ color: "var(--primary)" }}>$ </span>The problem
          </span>
          <h2
        ...
        <div className="problem-grid mt-14 grid md:grid-cols-3 gap-6">
          {CARDS.map((card) => (
            <div key={card.title} className="problem-card-wrap">
              <TiltCard
